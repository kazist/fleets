...
namespace Fleets\Drivers\Code\Tables;
 ...
 * Drivers
 *
 * @ORM\Table(name="fleets_drivers", indexes={@ORM\Index(name="user_id_index", columns={"user_id"})})
 * @ORM\Entity
...
class Drivers extends \Kazist\Table\BaseTable
{
     ...
     * @var integer
     *
     * @ORM\Column(name="documents", type="integer", length=11, nullable=true)
     */
    protected $documents;
